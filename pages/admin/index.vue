            ...
            <div class="lg:w-[calc(100%-500px)] md:w-[calc(100%-330px)] w-full md:pt-20 pt-14">
                <div class="max-w-[750px] mx-auto pb-24">
                    ...
                    <AddLink 
                        ...
                        :class="[{'mt-20 md:mt-8 mb-12 max-h-[1000px] transition-all duration-300 ease-in': showAddLink}, {'max-h-0 transition-all duration-300 ease-out': !showAddLink},]"
                    />

                    <div v-for="(link, i) in fakeLinks" class="mt-4" :key="`link_all_${i}`">
                        <LinkBox 
                            v-if="link"
                            :link="link" 
